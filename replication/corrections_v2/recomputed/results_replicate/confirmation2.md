...
K8 fidelity of taught forms, both − sender (SEED as the unit: matched-cell differences averaged within seed first; correction 2026-09-05): | 20 | 20/0 | +0.053 | [+0.044, +0.061] | 0.000 | SUPPORTED |
K8 fidelity, original pooled seed×cell line (dependent observations; kept for the changelog only): | 120 | 96/19 | +0.053 | [+0.041, +0.064] | 0.000 | SUPPORTED |
