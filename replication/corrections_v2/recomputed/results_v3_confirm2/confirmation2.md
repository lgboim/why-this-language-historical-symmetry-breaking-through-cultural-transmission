# K1–K9 on results_v3_confirm2 (seeds 10–29)
...
K8 fidelity of taught forms, both − sender (SEED as the unit: matched-cell differences averaged within seed first; correction 2026-09-05): | 20 | 20/0 | +0.052 | [+0.040, +0.064] | 0.000 | SUPPORTED |
K8 fidelity, original pooled seed×cell line (dependent observations; kept for the changelog only): | 120 | 91/24 | +0.052 | [+0.040, +0.064] | 0.000 | INCONCLUSIVE |
